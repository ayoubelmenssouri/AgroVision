...
<head>
    ...
    <link href="https://use.fontawesome.com/releases/v5.0.1/css/all.css" rel="styleshet"></head>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{asset('pack/img/fuetures.jpg')}}" alt="Image">
                    <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                        <div class="text-start p-5" style="max-width: 900px;">
                            <h3 class="text-white">Organic Grains</h3>
                            <h1 class="display-1 text-white mb-md-4">Good grain for better Yield</h1>
                            <a href="/contact" class="btn btn-primary py-md-3 px-md-5 me-3">Contact</a>
                            <a href="/about" class="btn btn-secondary py-md-3 px-md-5">Explore</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="w-100" src="{{asset('pack/img/carousel-2.jpg')}}" alt="Image">
                    <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                        <div class="text-start p-5" style="max-width: 900px;">
                            <h3 class="text-white">Best Types</h3>
                            <h1 class="display-1 text-white mb-md-4">Betthen Than Other</h1>
                            <a href="/contact" class="btn btn-primary py-md-3 px-md-5 me-3">Contact</a>
                            <a href="/about" class="btn btn-secondary py-md-3 px-md-5">Explore</a>
                        </div>
                    </div>
