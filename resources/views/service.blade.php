        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    ...
                    <a href="/grain" class="btn btn-secondary py-md-3 px-md-5">Grain</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-4">Our engineers And New Machine Product Best Quality And betther Value Than Marcket</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-item bg-light text-center p-5">
                        ...
                        <h4>Modern Truck</h4>
                        <p class="mb-0">We Use New And Lasted Machine For Best Quality</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                <div class="service-item bg-light text-center p-5">
                        ...
                        <h4>Farming Plans</h4>
                        <p class="mb-0">Our engineers study the latest plans for a good production</p>
                    </div>
                </div>
            </div>
        </div>
