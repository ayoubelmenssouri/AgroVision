...
<body>
           ...
           <main> <div class="container-fluid bg-trasparent my-4 p-3" style="position: relative;"> 
            <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3"> 
                ...
                <div class="col"> <div class="card h-100 shadow-sm"> 
                    <img src="{{ asset($grain->image_url) }}" class="card-img-top" alt="..."> 
                    <div class="card-body"> <div class="clearfix mb-3"> <span class="float-start badge rounded-pill bg-primary">{{ $grain['name_grain']}}</span> <span class="float-end price-hp" style="color: green">{{ $grain['price_unit']}} MAD;</span> </div> <h5 class="card-title">Article</h5> 
    ...
    <script src="{{asset('pack/lib/owlcarousel/owl.carousel.js')}}"></script>
